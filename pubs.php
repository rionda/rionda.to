...
<!-- vim: set ts=2 sw=2 tw=79: -->
			...
			<div id="pubs">
				...
				<ol id="journals">
					...
					<li>S. Haddadan, C. Menghini, M. Riondato, and E. Upfal. <a
						...
						Knowledge Discovery</em> (S. I. on Bias and Fairness),
				...
				<ol id="conferences">
					<li>M. Contreras-Catalan, M. Riondato. <span
						...
						Graphs, Hypergraphs, and Binary Matrices, <em>WWW'26</em>,
						2026.</li>
					<li>M. Abuissa, M. Riondato. <a
						...
						the Configuration Model of Vertex-Labeled Undirected
						Hypergraphs</a>, <em>ACM KDD'26</em>, 2026.</li>
				...
				<ol id="tutorials">
					...
					Mining</a> (<a
					href="papers/PellegrinaEtAl-HypTestSigPattTut-KDD19.pdf">2-pager</a>),
					<em>ACM KDD'19, SIAM SDM'20</em> (Slides TBD).</li>
		...
		<p class="notop"><a
			...
			&Ccedil;etintemel</a>, Michelle Contreras-Catalan,
			<a href="http://cs.brown.edu/~ccousins">Cyrus Cousins</a> Justin A.
			DeBrabant, <a href="https://www.gdfm.me/">Gianmarco De Francisci
			Morales</a>, Lorenzo De Stefani, <a
