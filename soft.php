...
<!-- vim: set ts=2 sw=2 tw=79: -->
		...
		Estimation.</p>
		<p><a href="parma.tar.bz2">PARMA</a>: Frequent Itemsets and Association
		Rule Mining for MapReduce (<a
		href="papers/RiondatoEtAl-PARMA.pdf">Paper</a>). PARMA is also used
		inside <a
